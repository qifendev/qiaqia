...
public class NotifyAdapter(private val addList: List<Message>, val context: Context) :
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        val message = addList[position]
        holder.friendsName.text = message.messageFrom
